...
class Tournament:
    ...
    def display_leaderboard(self):
        sorted_participants = sorted(self.participants, key=lambda x: x.portfolio.value, reverse=True)
...
if __name__ == "__main__":
    ...
    prizes = {
        "first_place": "Virtual Trophy",
        "second_place": "Honorable Mention"
    }
    fintasy_challenge = Tournament("Fintasy Paper Trade Challenge", "3 months", 100000, trading_rules, prizes)
